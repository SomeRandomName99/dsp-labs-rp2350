...
- [ ] Digital filter design (Currently taking a deep dive into filtering using 6.341x and EPFL DSP Specialization on coursera) [Lab learnings](lcavDSPLabs/audioPassThrough/lab3_digitalFilterDesign/Lab3Learnings.md)
- [ ] Granular synthesis
- [ ] Linear prediction
- [ ] DFT pitch shifting
